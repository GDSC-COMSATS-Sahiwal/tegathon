  ...
  return (
    <section className="w-full h-full text-white flex flex-col items-center justify-start min-h-0 gap-10 max-container">
      ...
      <div className="grid grid-cols-8 max-sm:grid-cols-6 w-full glass-container rounded-lg md:rounded-3xl border border-[#FDD200]">
        <div className="col-start-1 col-span-2 p-4 max-sm:col-span-2 max-sm:col-start-1 flex items-center justify-center rounded-tl-lg md:rounded-tl-3xl border-[#FDD200] max-sm:border-r max-sm:rounded-tl-lg">
          <Image
        ...
        <div className="col-start-3 col-span-2 p-4 max-sm:col-span-2 max-sm:col-start-3 flex items-center justify-center sm:border-l border-t max-sm:border-t-0 border-yellow-400">
          <Image
        ...
        <div className="col-start-5 col-span-2 p-4 max-sm:col-span-2 max-sm:col-start-5 flex items-center justify-center border-l border-t max-sm:border-t-0 border-yellow-400">
          <Image
